...
run_response = agent.run("Send an email to: 'michael@testai5.com' with subject 'hello' and with the body: 'What is the weather in tokyo?'")
...
while run_response.is_paused:
    ...
    if not final_response.is_paused:
...
run_response = agent.run("Get all of my emails")
